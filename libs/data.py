...
# def save_division_extrusion_ages(history,outdir,index=0):
#     dt = history[1].time-history[0].time
#     division_ages = []
#     extrusion_ages = []
#     for current_tissue,previous_tissue in zip(history[:-1],history[1:]):
#         previous_cells = previous_tissue.cell_ids
#         for cell in previous_cells:
#             if cell in current_tissue.extruded_cells:
#                 extrusion_ages.append(cell.age+dt)
#                 break
