...
import libs.pd_lib_density as lib 
...
OMEGA = 1.0 #OMEGA is strenth of denisty-dependence (OMEGA<<1 => weak, OMEGA=1 => strong)

rand = np.random.RandomState()

outdir = 'VTpd_%s_dd_death/omega_%.2f'%(game_str,OMEGA)
...
def run_parallel(b,i):
    ...
    """
    rand=np.random.RandomState()
    history = lib.run_simulation(lib.simulation_pd_density_dep,l,timestep,timend,rand,DELTA,OMEGA,game,(b,c),til_fix=True,mutant_num=1)
