...
def run_simulation(simulation,N,timestep,timend,rand,params,DELTA,game,game_constants,til_fix=False,mutant_num=1):
    ...
    # tissue = run(tissue, simulation(tissue,dt,10./dt,timestep/dt,rand,DELTA,KAPPA,N0,game,game_constants,False),10./dt,1./dt)[-1]
    # tissue.reset()
